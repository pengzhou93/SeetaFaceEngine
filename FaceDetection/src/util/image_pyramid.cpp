...
const cmss::ImageData* ImagePyramid::GetNextScaleImage(float* scale_factor) {
  if (scale_factor_ >= min_scale_) {
    ...
    cmss::ImageData src_img(width1x_, height1x_);
    cmss::ImageData dest_img(width_scaled_, height_scaled_);
