 ...
 *
 * This file is an example of how to use cmssFace engine for face detection, the
...
int main(int argc, char** argv) {
  ...
  cmss::FaceDetection detector(argv[2]);
  ...
  std::vector<cmss::FaceInfo> faces = detector.Detect(img_data);
