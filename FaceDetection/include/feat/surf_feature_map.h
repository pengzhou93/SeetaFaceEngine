...
#ifndef cmss_FD_FEAT_SURF_FEATURE_MAP_H_
#define cmss_FD_FEAT_SURF_FEATURE_MAP_H_
...
class SURFFeatureMap : public FeatureMap {
 ...
 private:
  ...
  cmss::fd::SURFFeaturePool feat_pool_;
};

}  // namespace fd
}  // namespace cmss

#endif  // cmss_FD_FEAT_SURF_FEATURE_MAP_H_
