...
#ifndef cmss_FD_FEAT_LAB_FEATURE_MAP_H_
#define cmss_FD_FEAT_LAB_FEATURE_MAP_H_
...
class LABFeatureMap : public cmss::fd::FeatureMap {
 public:
...
#endif  // cmss_FD_FEAT_LAB_FEATURE_MAP_H_
