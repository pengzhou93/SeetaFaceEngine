...
#ifndef cmss_FD_FUST_H_
#define cmss_FD_FUST_H_
...
class FuStDetector : public Detector {
 public:
  ...
  virtual std::vector<cmss::FaceInfo> Detect(cmss::fd::ImagePyramid* img_pyramid);
 ...
 private:
  std::shared_ptr<cmss::fd::ModelReader> CreateModelReader(cmss::fd::ClassifierType type);
  std::shared_ptr<cmss::fd::Classifier> CreateClassifier(cmss::fd::ClassifierType type);
  std::shared_ptr<cmss::fd::FeatureMap> CreateFeatureMap(cmss::fd::ClassifierType type);

  void GetWindowData(const cmss::ImageData & img, const cmss::Rect & wnd);
  ...
  std::vector<std::shared_ptr<cmss::fd::Classifier> > model_;
  std::vector<std::shared_ptr<cmss::fd::FeatureMap> > feat_map_;
  std::map<cmss::fd::ClassifierType, int32_t> cls2feat_idx_;
