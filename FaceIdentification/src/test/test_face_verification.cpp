...
int main(int argc, char* argv[]) {
  ...
  cmss::FaceDetection detector((MODEL_DIR + "/cmss_fd_frontal_v1.0.bin").c_str());
  ...
  cmss::FaceAlignment point_detector((MODEL_DIR + "/cmss_fa_v1.1.bin").c_str());

  // Initialize face Identification model 
  FaceIdentification face_recognizer((MODEL_DIR + "cmss_fr_v1.0.bin").c_str());
